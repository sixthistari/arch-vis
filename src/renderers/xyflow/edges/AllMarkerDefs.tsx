/**
 * Unified SVG marker definitions for all notation families.
 *
 * Merges ArchiMate markers (marker-*) and UML markers (uml-*) into a single
 * <defs> block rendered once in the canvas.
 */

export function AllMarkerDefs() {
  return (
